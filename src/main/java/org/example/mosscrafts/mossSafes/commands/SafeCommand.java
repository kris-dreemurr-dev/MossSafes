...
public class SafeCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("give")) {
            // Проверка на права оператора
            if (!player.isOp()) {
                player.sendMessage(ChatColor.RED + "[MossSafes] У вас нет прав для использования этой команды!");
                return true;
            }
            ...
            if (target == null) {
                player.sendMessage(ChatColor.RED + "Игрок не найден в сети!");
                return true;
            }
        ...
        if (args[0].equalsIgnoreCase("remove")) {
            ...
            if (locKey == null) {
                player.sendMessage(ChatColor.RED + "Сейф с таким названием не найден!");
                return true;
            }
        ...
        if (args[0].equalsIgnoreCase("chestlist")) {
            if (args.length < 2) {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (args.length == 1) {
            ...
            completions.addAll(Arrays.asList("remove", "changepassword", "chestlist"));
